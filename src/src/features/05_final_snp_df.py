...
binary_unique_snps_df = pd.read_csv("../data/interimm/binary_unique_snps_df.csv", "\t")
...
binarized_resistance_status_df = pd.read_csv("../data/processed/binarized_resistance_status_df.csv", "\t").rename(
