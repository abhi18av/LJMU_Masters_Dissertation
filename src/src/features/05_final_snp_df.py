...
hetero_binary_vcf_snps_with_mutations_df.to_csv("../../data/processed/final.hetero_binary_vcf_snps_with_mutations_df.tsv", "\t")
...
final_df.to_csv("../../data/processed/final.binarized_final_df.tsv", "\t")
